...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="mt-1 rounded-md bg-[#2D3748] border border-[#4A5568]"
      >
        <DropdownMenuItem
          onClick={() => setTheme("light")}
          className={`flex items-center gap-2 text-white hover:bg-[#38434F] ${
            theme === "light" ? "bg-[#38434F]" : ""
          }`}
        >
